...
This index keeps project follow-up work grouped by topic instead of mixing unrelated items in one file.
...
- Use topic files for actionable work.
- Keep design docs and architecture docs separate from TODO files.
- Keep this file short; it is only an index.
